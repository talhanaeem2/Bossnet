        ...
        <MainWapper isHeader={true} isFooter={false} icon={true}>
            <View style={styles.container}>
                <View style={styles.content}>
                    ...
                    <ScrollView style={{ width: 400, height: 420 }}>
                        <View style={styles.editFieldsContainer}>
                            <View style={styles.editField}>
                                <View style={styles.fieldText}>
                                    ...
                                    <TextRegular fontSize={17}>{userData?.firstName as string}</TextRegular>
                                </View>
                        ...
                        <TextBold style={styles.prefText} fontSize={15} color='rgba(0, 0, 0, 0.35)'>Preferences</TextBold>
