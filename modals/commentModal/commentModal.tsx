import { Modal, TouchableOpacity, View, TextInput, StyleSheet, Image } from "react-native"
...
import CommentModalProps from "./interfaces/commentModalProps"
...
const CommentModal = (props: CommentModalProps) => {
    const { commentCount, reactedNames, totalReactedCounts } = props;
    const isCommentModalVisible = useSliceSelector(state => state.app.modals.commentModal.isVisible);
    const dispatch = useReducerDispatch();

    const closeModal = () => {
        dispatch(setCommentModal({ modals: { isVisible: false } }))
    }
            ...
            >
                <View style={styles.commentModalContainer}>
                    ...
                    <View style={styles.likeContainer}>
                        ...
                        <TextRegular fontSize={11}>{`${commentCount.toString()} Comments`}</TextRegular>
                    </View>
                    <View>
